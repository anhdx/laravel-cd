		...
		<div id="content" class="space-top-none">
			...
			<div class="row">
				<div class="col-sm-8">
					...
					<div class="space20">&nbsp;</div>
					<form action="{{route('client.contact')}}" method="post" class="contact-form" novalidate>	@csrf
						@if($errors->has('name'))

							    <div class="alert alert-danger">{{$errors->first('name')}}</div>
							@endif

						<div class="form-block d-block">
							@if(Session::has('thanks'))
							<div class="alert alert-success">{{Session::get('thanks')}}</div>
						...
						<div class="form-block">
							...
							@endif
						<div class="form-block">
							<textarea name="message" placeholder="Your Message">{{old('email')}}</textarea>
						</div>
						<div class="form-block">
				...
				<div class="col-sm-4">
					...
					<p>
						...
						<a href="mailto:suchin171292@gmail.com">suchin171292@gmail.com</a>
					</p>
					<div class="space20">&nbsp;</div>
