...
<head>
	...
	<title>Banh keo full option </title>
	...
	<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> unknow Address</a></li>
						<li><a href=""><i class="fa fa-phone"></i>unknow phone number</a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="{{route('home')}}" id="logo"><img src="{{asset('source/assets/dest/images/logo-cake.png')}}" width="200px" alt=""></a>
				</div>
				<div class="pull-right beta-components space-left ov">
					...
					<div class="beta-comp">
						...
						@if(Session::has('cart'))
								...
								<div class="cart-item">
									<a class="cart-item-delete" href="{{route('removeCart',$productCart['item']['id']   )}}"><i class="fa fa-times"></i></a>
									<div class="media">
										<a class="pull-left" href="#"><img src="{{asset('source/image/product').'/'.$productCart['item']['image']}}" alt=""></a>
										<div class="media-body">
											<span class="cart-item-title">{{$productCart['item']['name']}}</span>
											
											<span class="cart-item-amount">{{$productCart['qty']}}*<span>@if($productCart['item']['promotion_price']==0) {{number_format($productCart['item']['unit_price'])}} VND @else {{number_format($productCart['item']['promotion_price'])}}@endif</span></span>
										</div>
									</div>
								</div>
								@endforeach
